...
class RBCAgent(AutonomousAgent):
    ...
    def tick(self, input_data, timestamp):
        ...
        if self.args.use_2d_detection:
            ...
            result['result_td'] = result_td
            result['result_od'] = result_od
            result['H'] = H
    ...
    def run_step(self, input_data, timestamp):
        ...
        stop_ = should_stop(tick_data['result_td'] , tick_data['result_od'], tick_data['lidar'],
                            self.vehicle_pos[:2], tick_data['compass'],
                            tick_data['H'], self.global_traj_node_id, partial_traj, vehicle_st_partial)
        ...
        if self.args.show_camera:
            image_center = input_data['rgb_right'][1][:, :, -2::-1]
