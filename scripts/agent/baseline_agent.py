...
import sys
sys.path.append('../..')
from IL.models.transfuser_baseline import TransFuser
from IL.config import GlobalConfig
from IL.data import scale_and_crop_image, lidar_to_histogram_features, transform_2d_points
...
class TransFuserAgent(autonomous_agent.AutonomousAgent):
    def setup(self, path_to_conf_file):
        ...
        model_dir = '/data/timothyha/carla/trained_models/transfuser_baseline/'
        self.net.load_state_dict(torch.load(os.path.join(model_dir, 'model_101.pth'), map_location=self.device))
