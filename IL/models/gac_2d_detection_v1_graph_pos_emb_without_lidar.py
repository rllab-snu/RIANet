...
class Object_encoder(nn.Module):
    ...
    def forward(self, img_hidden_features, img_class, img_mask, obj_num, img_mask_info):
        ...
        conv_feature = img_hidden_features.unsqueeze(1).expand(-1, self.max_obj_num, -1, -1,
...
class Encoder(nn.Module):
    def __init__(self, config):
        ...
        self.visual_pos_emb = nn.Parameter(torch.zeros(1, 2+2*self.config.max_obj_num, self.config.f_out))
